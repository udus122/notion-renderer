...
import type { Heading1ComponentBlockObject } from "@/types";
...
export const Default: Story = {
  args: {
    block: Heading1Object as Heading1ComponentBlockObject,
  },
};

export const Toggleable: Story = {
  args: {
    block: Heading1Toggleable as Heading1ComponentBlockObject,
  },
};
