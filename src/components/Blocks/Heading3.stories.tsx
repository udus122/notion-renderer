...
import type { Heading3ComponentBlockObject } from "@/types";
...
export const Default: Story = {
  args: {
    block: Heading3Object as Heading3ComponentBlockObject,
  },
};

export const Toggleable: Story = {
  args: {
    block: Heading3Toggleable as Heading3ComponentBlockObject,
  },
};
